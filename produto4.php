  ...
  display: flex;
    ...
    <main class="container">
      ...
      <!-- Left Column / Headphones Image -->
        ...
        <img data-image="black" src="C:\Users\pedri\Desktop\SITE/fotos/mug.png" style="width:38%; margin-top: 10px;">
        ...
        <div class="row">
            <div class="card border-white" style="margin-top: 100px;">
              <div class="card-body border-white w-100">
                <h5 class="card-title ">Caneca Dunder Mifflin 300mlㅤㅤㅤㅤ</h5>
